...
const UI = {
    ...
    renderWallet: function() {
        ...
        if (summary) {
            summary.innerHTML = `
                <div style="background: linear-gradient(135deg, #3b82f6, #1d4ed8); padding: 25px; border-radius: 20px; color: white; text-align: center; margin-bottom: 20px;">
    ...
    handleWithdrawal: async function() {
        ...
        alert(res.message || (res.success ? "Withdrawal Success!" : "Error"));
